...
import Database.DB;
import Model.SupplierExcelReport;
...
public class Suppliers extends javax.swing.JFrame {
    ...
    public Suppliers(Main mMenu, String user) {
        this();
        this.menu = mMenu;
        this.user_Type = user;
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "ID", "Supplier", "City", "Contact No"
            }
        ) {
        ...
        panel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 200, 1040, 450));
        ...
        panel.add(btn_Export, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 110, 130, 35));

        btn_newSupplier.setBackground(new java.awt.Color(41, 128, 185));
        btn_newSupplier.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btn_newSupplier.setForeground(new java.awt.Color(255, 255, 255));
        btn_newSupplier.setText("New Supplier");
        btn_newSupplier.setBorder(null);
        btn_newSupplier.setBorderPainted(false);
        btn_newSupplier.setContentAreaFilled(false);
        btn_newSupplier.setFocusPainted(false);
        btn_newSupplier.setOpaque(true);
        btn_newSupplier.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                btn_newSupplierMouseReleased(evt);
            }
        });
        ...
        panel.add(btn_newSupplier, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 110, 130, 35));
        ...
        panel.add(searchBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 110, 350, 35));
    ...
    private void btn_newSupplierMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_newSupplierMouseEntered
        btn_newSupplier.setBackground(new Color(31, 97, 141));
    ...
    private void btn_newSupplierMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_newSupplierMouseExited
        btn_newSupplier.setBackground(new Color(41, 128, 185));
    ...
    private void btn_newSupplierMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_newSupplierMousePressed
        btn_newSupplier.setBackground(new Color(21, 67, 96));
    }//GEN-LAST:event_btn_newSupplierMousePressed

    private void btn_newSupplierMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_newSupplierMouseReleased
        btn_newSupplier.setBackground(new Color(31, 97, 141));
    }//GEN-LAST:event_btn_newSupplierMouseReleased
    ...
    private void btn_newSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_newSupplierActionPerformed
        if (user_Type.equals("Admin")) {
            AddSupplier addSup = new AddSupplier(menu, this, true);
            addSup.setVisible(true);

        } else if (user_Type.equals("Cashier") | user_Type.equals("Manager") | user_Type.equals("DataEntry")) {
    ...
    private void btn_ExportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ExportActionPerformed
        if (user_Type.equals("Admin") | user_Type.equals("Manager") | user_Type.equals("DataEntry")) {
            ...
            chooser.setSelectedFile(new File("SupplierDetailsReport" + sdf.format(new Date())));
            ...
            if (retrival == JFileChooser.APPROVE_OPTION) {
                ...
                SupplierExcelReport.writeExcel("Supplier Details", saveFile);
                menu.setCursor(null);
            }
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        if (evt.getClickCount() == 2) {
            DefaultTableModel dtm = (DefaultTableModel) table.getModel();
            String supplierID = dtm.getValueAt(table.getSelectedRow(), 1).toString().trim();
            AddSupplier cus = new AddSupplier(menu, this, false);
            cus.setVisible(true);
            cus.updateData(supplierID);
        }
