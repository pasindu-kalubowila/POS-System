...
public class Digital_Printing_Qualities extends javax.swing.JFrame {

    public Digital_Printing_Qualities() {
        initComponents();
        tableSettings();
        loadData();
    }
    ...
    private void initComponents() {
        ...
        txt_quality.setFont(new java.awt.Font("Calibri", 0, 16)); // NOI18N
        txt_quality.setForeground(new java.awt.Color(39, 55, 70));
        txt_quality.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txt_qualityKeyTyped(evt);
            }
        });
        panel.add(txt_quality, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, 350, 30));

        jLabel1.setFont(new java.awt.Font("Calibri", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(52, 73, 94));
        jLabel1.setText("Qualities");
        panel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 150, 50));
    ...
    private void txt_qualityKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_qualityKeyTyped
        Validation.setLength(evt, txt_quality.getText(), 50);
    }//GEN-LAST:event_txt_qualityKeyTyped

    private void btn_AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_AddActionPerformed
        if (!txt_quality.getText().isEmpty()) {
            try {
                DB.iud("INSERT INTO print_quality (quality) VALUES('" + txt_quality.getText() + "')");
                new Save().setVisible(true);
                txt_quality.setText(null);
                loadData();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Digital_Printing_Qualities.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Digital_Printing_Qualities().setVisible(true);
            }
        });
    }
