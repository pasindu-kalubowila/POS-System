...
import Database.AddEmployee_first_time;
import Database.DB;
...
public class Loding extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Plex.png"))); // NOI18N
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    for (int i = 0; i < 101; i++) {
                        if (i == 10) {
                            ResultSet rs = DB.search("SELECT COUNT(*)AS cn FROM `employee`");
                            if (rs.next()) {
                                if (rs.getInt(1) == 0) {
                                    AddEmployee_first_time ae = new AddEmployee_first_time();
                                    ae.setVisible(true);
                                    dispose();
                                } else {
                                    LogIn l = new LogIn();
