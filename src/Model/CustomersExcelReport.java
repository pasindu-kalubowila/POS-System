...
public class CustomersExcelReport {

    private static final String[] columnHeader = {"Customer Id", "First Name", "Last Name", "Gender", "NIC", "Company",
         "Email", "Mobile", "Street", "City", "Active Status"};
    ...
    public static void writeExcel(String sheetName, String path) {
        ...
        try {
            ...
            try {
                ResultSet rs = DB.search("select * from customer"); //get data from database
